...
public class RecordController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "몸무게 기록 삭제 성공", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseDTO.class))
            }),
            @ApiResponse(responseCode = "404", description = "기록 없음", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ErrorResponseDTO.class))
            })
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "기력 기록 삭제 성공", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseDTO.class))
            }),
            @ApiResponse(responseCode = "404", description = "기록 없음", content = {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "식욕 기록 삭제 성공", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseDTO.class))
            }),
            @ApiResponse(responseCode = "404", description = "기록 없음", content = {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "호흡수 기록 삭제 성공", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseDTO.class))
            }),
            @ApiResponse(responseCode = "404", description = "기록 없음", content = {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "심박수 기록 삭제 성공", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseDTO.class))
            }),
            @ApiResponse(responseCode = "404", description = "기록 없음", content = {
    ...
    @Operation(summary = "실신 기록 삭제", description = "특정 ID의 실신 기록을 삭제합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "실신 기록 삭제 성공", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseDTO.class))
            }),
            @ApiResponse(responseCode = "404", description = "기록 없음", content = {
    ...
    public ResponseEntity<ResponseDTO<String>> deleteSyncope(@PathVariable Long recordId) {
        ...
        return ResponseEntity.ok(new ResponseDTO<>(SuccessCode.SUCCESS_DELETE_RECORD, "실신 기록이 성공적으로 삭제되었습니다."));
    }

    @DeleteMapping("/urinary/{recordId}")
    @Operation(summary = "소변 기록 삭제", description = "특정 ID의 소변 기록을 삭제합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "소변 기록 삭제 성공", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseDTO.class))
            }),
            @ApiResponse(responseCode = "404", description = "기록 없음", content = {
    ...
    @Operation(summary = "특이사항 기록 삭제", description = "특정 ID의 특이사항 기록을 삭제합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "특이사항 기록 삭제 성공", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseDTO.class))
            }),
            @ApiResponse(responseCode = "404", description = "기록 없음", content = {
    ...
    @Operation(summary = "경련 기록 삭제", description = "특정 ID의 경련 기록을 삭제합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "경련 기록 삭제 성공", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseDTO.class))
            }),
            @ApiResponse(responseCode = "404", description = "기록 없음", content = {
    ...
    @Operation(summary = "이상 소리 기록 삭제", description = "특정 ID의 이상 소리 기록을 삭제합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "이상 소리 기록 삭제 성공", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseDTO.class))
            }),
            @ApiResponse(responseCode = "404", description = "기록 없음", content = {
    ...
    @Operation(summary = "콧물 기록 삭제", description = "특정 ID의 콧물 기록을 삭제합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "콧물 기록 삭제 성공", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseDTO.class))
            }),
            @ApiResponse(responseCode = "404", description = "기록 없음", content = {
    ...
    @Operation(summary = "구토 기록 삭제", description = "특정 ID의 구토 기록을 삭제합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "구토 기록 삭제 성공", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseDTO.class))
            }),
            @ApiResponse(responseCode = "404", description = "기록 없음", content = {
    ...
    @Operation(summary = "걷는 모습 기록 삭제", description = "특정 ID의 걷는 모습 기록을 삭제합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "걷는 모습 기록 삭제 성공", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseDTO.class))
            }),
            @ApiResponse(responseCode = "404", description = "기록 없음", content = {
    ...
    @Operation(summary = "음수량 기록 삭제", description = "특정 ID의 음수량 기록을 삭제합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "음수량 기록 삭제 성공", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseDTO.class))
            }),
            @ApiResponse(responseCode = "404", description = "기록 없음", content = {
    ...
    public ResponseEntity<ResponseDTO<String>> deleteWater(@PathVariable Long recordId) {
        ...
        return ResponseEntity.ok(new ResponseDTO<>(SuccessCode.SUCCESS_DELETE_RECORD, "음수량 기록이 성공적으로 삭제되었습니다."));
    }

    @DeleteMapping("/skin/{recordId}")
    @Operation(summary = "피부 상태 기록 삭제", description = "특정 ID의 피부 상태 기록을 삭제합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "피부 상태 기록 삭제 성공", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseDTO.class))
            }),
            @ApiResponse(responseCode = "404", description = "기록 없음", content = {
    ...
    @Operation(summary = "배변 기록 삭제", description = "특정 ID의 배변 기록을 삭제합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "배변 기록 삭제 성공", content = {
                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseDTO.class))
            }),
            @ApiResponse(responseCode = "404", description = "기록 없음", content = {
